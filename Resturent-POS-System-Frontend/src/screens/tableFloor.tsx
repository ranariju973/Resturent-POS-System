...
export function TableFloor() {
  ...
  return (
    ...
    >
      ...
      <div style={{ ...card, flex: 1, minHeight: 0, overflowY: 'auto', padding: 16 }}>
        <div
          style={{
            display: 'grid',
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
          <span style={{ fontSize: 22, fontWeight: 800, lineHeight: 1, color: tone.fg }}>
            {table.name}
          </span>
          <span
            style={{
        ...
        {occupied ? (
          ...
          >
            ...
            <span style={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'flex-end' }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: '#6b4f12' }}>
