    ...
    >
      ...
      <div
        style={{
          ...
          minHeight: 0,
          display: 'grid',
          gridTemplateColumns: isMobile ? 'none' : 'repeat(4, minmax(240px, 1fr))',
          gridAutoFlow: isMobile ? 'column' : undefined,
          gridAutoColumns: isMobile ? '86%' : undefined,
          ...
          return (
            <section
              ...
              style={{
                ...
                // Each column parks itself under the thumb when swiped to.
